...
Task 2 authority-context correction: preserve terminal player facts; project only already safe public roles, draft-selected cosmetic actions and current confirmed quest completion evidence. Policy revision8 binds this request change. Focused100/100 and final26/26 plus typecheck pass; root scoped review found no remaining issue. New whole acceptance and independent scoped re-review remain pending.
