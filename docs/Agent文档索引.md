...
| 当前开发阶段 | `agent/当前开发阶段.md` | `agent/current-phase.json` | Phase 7：地图优先地点冒险主循环已计划（planned / not_started，单仓 `codex/phase7-map-scene-playable-loop-planning`）；唯一 Plan：`superpowers/plans/2026-07-29-mvp-phase-7-map-first-location-playable-loop.md`；Spec：`superpowers/specs/2026-07-29-map-first-location-playable-loop-design.md` |
...
| 地图与地点冒险 | `agent/地图与地点冒险.md` | `策划文档/AI生成RPG_MVP.md` | Phase 7 计划中（planned / not_started，实现未开始）：地图旅行层四状态节点、地点点击互动、`dialogue_choice` 固定对话与 SVG 占位视觉；Spec：`superpowers/specs/2026-07-29-map-first-location-playable-loop-design.md`；Plan：`superpowers/plans/2026-07-29-mvp-phase-7-map-first-location-playable-loop.md` |
