...
const PREFIX = "[phase11-journey]";
const TEST_FILE = "src/game/application/testing/phase11StoryContinuityJourney.test.ts";
...
export function main({
  ...
  const artifactRoot = resolve(projectRoot, "artifacts", "phase11-journey");
  ...
  const childEnv = {
    ...
    PHASE11_JOURNEY_ARTIFACT_DIR: artifactDir,
  };
