  ...
  return {
    async generate() {
      const loc: LocationEntry = {
        id: asLocationId("loc_start"), name: "起始客栈", description: "一间简朴的客栈", kind: "main",
        connectedLocationIds: [], npcIds: [asNpcId("npc_innkeeper")], availableItemIds: [], tags: [],
      };
      const npc: NpcEntry = {
        id: asNpcId("npc_innkeeper"), name: "客栈老板", role: "路人", description: "热情的客栈老板",
