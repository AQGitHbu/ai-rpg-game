...
只输出一个 JSON 对象，不要代码围栏或解释。只返回 {"verdict":"pass"|"reject"|"uncertain","failedIds":[]}。pass/uncertain 的 failedIds 必须为空；reject 至少一个输入 item.id。不得返回原因、类别、scope 或新 ID。无法判断时明确 uncertain。
