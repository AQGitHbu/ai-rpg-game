...
export function createRuleIntentParserV2(): IntentParserSource {
  return {
    sourceVersion: "rule-intent-v2",
 ...
 */
export function createV2IntentParserSource(
  ...
  if (baseUrl !== "" && apiKey !== "" && model !== "" && transport !== undefined) {
    return createLiveIntentParserV2(transport, { baseUrl, apiKey, model });
  }
  return createRuleIntentParserV2();
}
